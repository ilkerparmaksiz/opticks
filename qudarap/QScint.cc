...
void QScint::ConfigureLaunch( dim3& numBlocks, dim3& threadsPerBlock, unsigned width, unsigned height )  // static
{
...
void QScint::lookup( float* lookup, unsigned num_lookup, unsigned width, unsigned height  ) const
{
    LOG(LEVEL) << "[" ;
    dim3 numBlocks ;
    dim3 threadsPerBlock ;
...
void QScint::Dump( float* lookup, unsigned num_lookup, unsigned edgeitems  ) // static
{
    LOG(LEVEL);
